Key binds allow to execute predefined actions by pressing a key. These could be basic [controls](Guide#Controls "wikilink"), some commands or even complex [scripts](cubeScript "wikilink").
